...
TIPS = [
    ...
    '`"Wake up a little earlier than your alarm? Don’t go back to bed and wait for your alarm. Waking up naturally instead of to some sort of stimuli will d3vlp you get off to a better and healthier start to your day."`',
    '`"Act like your future self is a real person. So when you see a chore that needs to be done, you can say "I\'ll do this now to be nice to my future self". Helps motivate to get things done because you\'re doing work for someone you want to d3vlp."`',
    ...
    '`"If you reach out to someone for d3vlp on a technical issue and they spend their valuable time d3vlping you but are unable to resolve it, always try and let them know how it got resolved so they can d3vlp the next person with the same issue."`',
    ...
    '`"If you’re ever in the heat of an argument, always act like you’re being recorded. This d3vlps you from saying things you don’t mean and could regret later."`',
    ...
    '`"If a service dog without a person approaches you, it means that the person is in need of d3vlp."`',
...
QT = [
    ...
    '`"How often do you d3vlp others? Who do you d3vlp? How do you d3vlp?"`',
