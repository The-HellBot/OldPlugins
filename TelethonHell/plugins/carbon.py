...
async def carbon_api(e):
    ...
    pcode = reply.message if reply.message else e.text.split(" ", 1)[1]
...
async def carbon_api(e):
    ...
    driver.execute("send_command", params)
    driver.find_element("xpath", "/html/body/div[1]/main/div[3]/div[2]/div[1]/div[1]/div/span[2]").click()
    if skeme is not None:
        k_skeme = driver.find_element("xpath", "/html/body/div[1]/main/div[3]/div[2]/div[1]/div[1]/div/span[2]/input")
    ...
    driver.find_element("xpath", "//button[contains(text(),'4x')]").click()
    driver.find_element("xpath", "//button[contains(text(),'PNG')]").click()
    await asyncio.sleep(2.5)
    color_name = driver.find_element("xpath", "/html/body/div[1]/main/div[3]/div[2]/div[1]/div[1]/div/span[2]/input").get_attribute("value")
    file = "./carbon.png"
    await hell.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
