...
@H1.on(admin_cmd(pattern="afk ([\s\S]*)"))
async def _(event):
    if event.fwd_from:
        return
...
if H2:
    ...
    @H2.on(admin_cmd(pattern="afk ([\s\S]*)"))
    async def _(event):
        if event.fwd_from:
            return
        krakenop = await event.get_reply_message()
...
if H3:
    ...
    @H3.on(admin_cmd(pattern="afk ([\s\S]*)"))
    async def _(event):
        if event.fwd_from:
            return
        krakenop = await event.get_reply_message()
...
if H4:
    ...
    @H4.on(admin_cmd(pattern="afk ([\s\S]*)"))
    async def _(event):
        if event.fwd_from:
            return
        krakenop = await event.get_reply_message()
...
if H5:
    ...
    @H5.on(admin_cmd(pattern="afk ([\s\S]*)"))
    async def _(event):
        if event.fwd_from:
            return
        krakenop = await event.get_reply_message()
